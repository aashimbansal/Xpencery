...
const Home = () => {
        ...
        },
        {
            ...
            expenses: [
                ...
                },
                {
                    id: 10,
                    title: "Electronics",
                    description: "Earphones/Mouse/Etc.",
                    location: "Croma",
                    total: 2000,
                    status: pendingStatus,
                },
    ...
    function renderHeader() {
        return (
            <View style={{ paddingHorizontal: SIZES.padding, paddingVertical: SIZES.padding, backgroundColor: COLORS.black }}>
                <View>
                    <Text style={{ color: COLORS.lightBlue, ...FONTS.h2 }}>My Expenses</Text>
                ...
                <View style={{ flexDirection: 'row', marginTop: SIZES.padding, alignItems: 'center' }}>
                    ...
                    <View style={{ marginLeft: SIZES.padding }}>
                        <Text style={{ color: COLORS.lightBlue, ...FONTS.h3 }}>27 Feb, 2022</Text>
                    </View>
                </View>
            </View>
        )
    ...
    function renderCategoryHeaderSection() {
        return (
            <View style={{ flexDirection: 'row', padding: SIZES.padding, justifyContent: 'space-between', alignItems: 'center' ,backgroundColor: COLORS.gray}}>
                {/* Title */}
                <View>
    ...
    function renderIncomingExpenses() {
        ...
        const renderItem = ({ item, index }) => (
            <View style={{
                ...
                >
                    <Text style={{ color: COLORS.white, ...FONTS.body3 }}>CONFIRM {item.total.toFixed(2)} RUPEE</Text>
                </View>
            </View>
        )
        ...
        const renderItem = ({ item }) => (
            ...
            >
                ...
                <View style={{ justifyContent: 'center' }}>
                    <Text style={{ color: (selectedCategory && selectedCategory.name == item.name) ? COLORS.white : COLORS.primary, ...FONTS.h3 }}>{item.y} RUPEE - {item.label}</Text>
                </View>
            </TouchableOpacity>
        )
